...
# Afluence de touristes par quart d'annee de 2008 à 2016
...
p+labs(title="Afluence de touristes par quart d'année \n de 2008 à 2016",x ="Année", y = "Nombre de touristes")

# Recuperer le dataset sur les crimes a Londres
crimes <- read.table(file="london_crime_by_lsoa.csv",header=TRUE,sep=",")
# Traiter les donnees sur le crime pour qu'elles soient comparables avec les données sur l'affluence : ajout de la colonne quarter
...
p+labs(title="Nombres de vols par quart d'année \n de 2008 à 2016",x ="Année", y = "Nombre de vols")
...
p+labs(title="Nombres de cas violences contre la personne \n par quart d'année  de 2008 à 2016",x ="Année", y = "Nombre de cas")
